    ...
    public void MainMenuUI()throws SQLException {
        ...
        while (InventoryChoice != 5) {
            ...
            switch (InventoryChoice)
            {
                ...
                case 4:{categoryUI();
                break;}
                case 5:{System.out.println("Exiting to Main menu");
                    break;}
                default:{System.out.println("Invalid choice, please try again");
                    break;}
            }
...
//            System.out.println("2. Search for expired items ");   //It might not be part of the menu
            ...
            switch (branchChoice) {
                ...
                case 9: {System.out.println("9. Receiving an order from supplier ");
                    //TODO : Use the function From Storage To Store
