...
public class TransportMangerUI {
            ...
            try {
                ...
                switch (choice_main_menu_1) {
                    ...
                    case 3:
                        ...
                        transportController.print_Trucks();
                        continue_menu_1 = false;
                        break;
            ...
            try {
                ...
                switch (printing_choice) {
                    ...
                    case 1:
                        ...
                        transportController.print_active_transports_Controller();
                        keep_menu = false;
                        break;
                    ...
                    case 2:
                        ...
                        transportController.print_former_transport_document_Controller();
                        keep_menu = false;
                        break;
                    ...
                    case 3:
                        ...
                        transportController.print_transport_document_Controller();
                        keep_menu = false;
                        break;
                    ...
                    case 4:
                        ;
                        /** printing the transport's documents if exist */
                        transportController.print_transport_order_Controller();
                        keep_menu = false;
                        break;
    ...
    public void enter_new_TransportOrder() {
        ...
        if (!transportController.check_if_existing_any_Site_Controller()) {
        ...
        while (checking_legal) {
            ...
            try {
                ...
                find_source = (Source) transportController.find_source_Controller(source_code_input);
                if (find_source == null) {
                    System.out.println("Source ID cannot be found in the system, please try again");
                    continue;
                }
                find_dest = (Destination) transportController.find_destination_Controller(destination_code_input);
                if (find_dest == null) {
    ...
    public void Manage_Active_Transports() {
        ...
        if (transportController.getAll_transport_shipments().size() == 0) {
        ...
        ATruck current_truck = transportController.get_truck_of_transport(chosen_shipment_to_manage.getTransport_document().getTruck_license_plate_number());
        ...
        if (current_location.equals("B")) {
            ...
            if (is_shipment_finished.equals("Y")) {
                transportController.Finish_Transport_Controller(chosen_shipment_to_manage);
            }
        }
            ...
            if (transportController.WeightTruck(chosen_shipment_to_manage, current_truck, current_weight)) {
    ...
    public void Handle_OverWeight (TransportShipment chosen_shipment_to_manage, int current_weight) {
        ...
        while (keep_menu) {
            ...
            try {
                ...
                TransportOrder current_transport_order = transportController.get_transport_order_by_id(current_transport_order_id);
                double max_weight_allowed = transportController.get_truck(chosen_shipment_to_manage.getTruck_license_plate_number()).getMax_cargo_weight() +
                        transportController.get_truck(chosen_shipment_to_manage.getTruck_license_plate_number()).getNet_weight();
    ...
    public int get_specific_transport_order_id (TransportShipment chosen_transport_shipment) {
        ...
        while (true) {
            ...
            try {
                ...
                if (transportController.get_transport_order_by_id(current_transport_order_id) == null) {
    ...
    public void addTruck() {
        ...
        while (true) {
            ...
            try {
                ...
                if (transportController.check_if_truck_plate_number_exist(truck_license_plate_insert)) {
        ...
        transportController.add_Truck(truck_license_plate_insert, truck_net_weight_insert, max_cargo_weight_insert, truck_level_type_insert);
    }
    ...
    public void removeTruck(){
        ...
        while (true) {
            ...
            if (!transportController.check_if_truck_plate_number_exist(license_plate_number_truck_to_remove)) {
                System.out.println("This license plate number is not in the system.");
            } else break;
        }
        transportController.remove_Truck(license_plate_number_truck_to_remove);
    }
    ...
    public Pair<Product,Integer> removingProducts(TransportOrder order) {
        ...
        while (true) {
            ...
            product_to_remove = transportController.return_product_if_exist_Controller(productCode);
        ...
        transportController.update_product_amount_in_order_controller(order,product_to_remove,former_value[0] - amount);
    ...
    public void HandleWeight_RemoveItems (TransportShipment shipment, TransportOrder current_transport_order, double max_weight_allowed) {
            ...
            int max_order_id = transportController.get_all_transport_orders_id_controller();
            ...
            while (keep_remove) {
                ...
                transportController.update_product_amount_in_order_controller(new_transport_order_after_remove_items,
                ...
                if (Objects.equals(keep_removing_choice, "N")) {
                    ...
                    if (keep_removing_choice.equals("N")) {
                        ...
                        transportController.add_new_transport_order(new_transport_order_after_remove_items);
                        transportController.setWeight(shipment, new_cargo_weight_of_transport);
                        keep_remove = false;
                        break;
                    }
                }
    ...
    public ATruck get_a_suitable_truck(TransportShipment chosen_shipment_to_manage, int current_weight) {
        ...
        Set<Integer> truck_choices = transportController.printing_truck_by_type_totalWeight_availability(chosen_shipment_to_manage, current_weight);
        if (truck_choices == null) {
            System.out.println("Sorry, there aren't available trucks");
            return null;
        }
        System.out.println("Please enter a truck licence plate number from the following options: ");
        System.out.println("");

        int new_truck_license_plate;
        ATruck truck_chosen;
        while (true) {
            Scanner console18 = new Scanner(System.in);
            try {
                new_truck_license_plate = console18.nextInt();
                truck_chosen = transportController.get_truck(new_truck_license_plate);
                if (!truck_choices.contains(truck_chosen.getLicense_plate_number())) {
                    System.out.println("Wrong option. Please choose a licence plate number from the above list. ");
                }
                else break;
            }
            catch (Exception e) {
    ...
    public void HandleWeight_ChangeTruck (TransportShipment transportShipment, int current_weight) {
        ...
        Driver new_driver_for_transport = transportController.get_driver_in_company_controller(ID_chosen);
    ...
    public String get_a_suitable_driver_ID (TransportShipment transportShipment, ATruck chosen_truck) {
        ...
        while (checking) {
            System.out.println(transportController.display_available_drivers_controller(transportShipment.getTransport_document().getDate(), transportShipment.getTransport_document().getDeparture_time(),
            ...
            boolean add_driver_succeed = transportController.add_driver_to_shift_controller(ID_chosen,
    ...
    public HashMap<Product, Integer> product_for_order(){
        ...
        while (true) {
            ...
            while (checking_legal) {
                ...
                new_product = transportController.return_product_if_exist_Controller(product_code_input);
                if (new_product == null) {
    ...
    public void execute_transport () {
        ...
        int sum_of_transport_controller = transportController.get_num_of_waiting_transport_documents();
    ...
    public void creating_new_transport_document(){
        ...
        if (!transportController.check_if_exist_unsigned_transport_orders()) {
        ...
        while (true) {
            ...
            try {
                ...
                transportOrder_to_ship = transportController.get_transport_order_by_id(transport_order_choice);
        ...
        if (Objects.equals(present_choice, "Y")) {
            ...
            index_list = transportController.represent_all_transport_documents_by_type(order_type,
            ...
            if (!index_list.isEmpty()) {
                ...
                while (legal_checking) {
                    System.out.println("Please enter the ID of the transport document you want to add to: ");
                    Scanner console11 = new Scanner(System.in);
                    try {
                        transport_document_choice_to_add_order = console11.nextInt();

                        if (!index_list.contains(transport_document_choice_to_add_order)) {
                        ...
                        transportOrder_to_ship.setAssigned_doc_id(transport_document_choice_to_add_order);
                        transportController.update_transport_order(transportOrder_to_ship);
                        transportController.updating_documents_in_the_system(transportOrder_to_ship, transport_document_choice_to_add_order);
        ...
        while (no_available_storekeeper_try_again) {
            ...
            boolean check_if_exist_storekeeper = transportController.check_if_storeKeeperA_assigned(transportOrder_to_ship.getDestination().getID(), date, departureTime);

            if (check_if_exist_storekeeper) {

                System.out.println("Please enter the license plate number of the truck you want to choose: ");
                ...
                index_list = transportController.represent_all_trucks_exist_by_type_and_available(level_skill, date);
                if (index_list.isEmpty()) {
                ...
                while (legal_checking) {
                    ...
                    try {
                        ...
                        if (!index_list.contains(truck_choice)) {
                            System.out.println("Wrong choice, please try again ");
                            continue;
                        }
                        legal_checking = false;
                ...
                ATruck chosen_truck = transportController.get_truck(truck_choice);

                index_list.clear();
                String ID_chosen = null;
                boolean checker_available_drivers = true;
                while (!checker5) {
                    String result_available_drivers = transportController.display_available_drivers_controller(date, departureTime, chosen_truck.getNet_weight(), chosen_truck.getTruck_level());
                    ...
                    boolean add_driver_succeed = transportController.add_driver_to_shift_controller(ID_chosen, date, departureTime);
                ...
                TransportOrder transport_order_to_add = transportController.get_transport_order_by_id(transport_order_choice);
                ...
                Driver chosen_driver = transportController.get_driver_in_company_controller(ID_chosen);
                /** making the new transport document and adding it into the system
                 * and removing the old transport order from the system */
                transportController.creating_new_transport_document(date, chosen_truck.getLicense_plate_number(), departureTime, chosen_driver, all_transport_orders_into_document, transport_order_to_add.getDestination().getAddress().getShipping_area(), order_type);
                transportController.update_truck_transports_controller(chosen_truck, date);
                no_available_storekeeper_try_again = false;
        ...
        try {
            ...
            while (true) {
                ...
                try {
                    ...
                    if (transportController.check_if_document_id_exist(document_ID)){
                        break;
                    }
                    else {
            ...
            /** looking for the transport document that the manager chose */
            return transportController.get_transport_document_by_id(document_ID);
        }
        catch (Exception e) {
    ...
    public TransportShipment chosen_transport_shipment () {
        ...
        while (true) {
            ...
            try {
                ...
                transportShipment_chosen = transportController.get_transport_shipment_by_id(shipment_number);
    ...
    public void switch_truck_status () {
        ...
        while (true) {
            ...
            if (!transportController.check_if_truck_plate_number_exist(license_plate_number)) {
                System.out.println("This license plate number is not in the system.");
            } else break;
        }

        transportController.switch_truck_status_controller(license_plate_number);
